...
[![PDF Manuscript](https://img.shields.io/badge/manuscript-PDF-blue.svg)](https://bluegenes.github.io/2022-paper-protein-kmers/manuscript.pdf)
[![GitHub Actions Status](https://github.com/bluegenes/2022-paper-protein-kmers/workflows/Manubot/badge.svg)](https://github.com/bluegenes/2021-paper-protein-kmers/actions)
...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/bluegenes/2022-paper-protein-kmers/tree/gh-pages) and [`output`](https://github.com/bluegenes/2021-paper-protein-kmers/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://bluegenes.github.io/2022-paper-protein-kmers/
+ **PDF manuscript** at https://bluegenes.github.io/2022-paper-protein-kmers/manuscript.pdf
...
Please attribute by linking to https://github.com/bluegenes/2022-paper-protein-kmers.
...
Please open [an issue](https://github.com/bluegenes/2022-paper-protein-kmers/issues) for any question related to licensing.
